...
var lastOpenPDatePicker = !1,
  ...
  PERSIAN_MONTH_NAMES =
    "\u0641\u0631\u0648\u0631\u062f\u06cc\u0646 \u0627\u0631\u062f\u0628\u06cc\u0647\u0634\u062a \u062e\u0631\u062f\u0627\u062f \u062a\u06cc\u0631 \u0645\u0631\u062f\u0627\u062f \u0634\u0647\u0631\u06cc\u0648\u0631 \u0645\u0647\u0631 \u0622\u0628\u0627\u0646 \u0622\u0630\u0631 \u062f\u06cc \u0628\u0647\u0645\u0646 \u0627\u0633\u0641\u0646\u062f".split(
      " "
    ),
  PERSIAN_SHORT_WEEKDAY_NAMES =
    "\u0634 \u06cc\u06a9 \u062f\u0648 \u0633\u0647 \u0686\u0647 \u067e\u0646 \u062c\u0645".split(
      " "
    );
...
AMIB.persianCalendar = function (b, a) {
  ...
  this.input = A$(b);
  for (d in a)
    d in c ? (c[d] = a[d]) : alert(d.toString() + " option is not supported");
  c.defaultDate instanceof Array ||
    (c.defaultDate = isPersianDate(c.defaultDate));
  d = this.input;
...
AMIB.persianCalendar.prototype.createDateTable = function (b, a, c) {
  ...
  j = jd_to_persian(f);
  (a = isPersianDate(a))
    ? (a = persian_to_jd(a[0], a[1], a[2]))
    : g
    ? ((a = persian_to_jd(g[0], g[1], g[2])), (c = g.join("/")))
    : (a = f);
  c = isPersianDate(c);
  a = jd_to_persian(a);
    ...
    cTN(
      enDigitsToFa(
        "\u0627\u0645\u0631\u0648\u0632: " +
          j[2].toString() +
          " " +
          PERSIAN_MONTH_NAMES[j[1] - 1].toString() +
          " " +
          j[0].toString()
      )
    )
...
AMIB.persianCalendar.prototype.setMenuPos = function (b, a) {
  var c = getOffset(a);
  b.style.top =
    0 > c.top - b.offsetHeight ||
    getScrollTop() + getViewPortHeight() >
      c.top + a.offsetHeight + b.offsetHeight
      ? c.top + a.offsetHeight + "px"
      : c.top - b.offsetHeight + "px";
  c = getOffset(a);
...
AMIB.persianCalendar.prototype.normalizeUserInput = function () {
  var b = this.input,
    ...
    c = faDigitsToEn(c);
  (a = isPersianDate(c))
    ? this.fillDateField(a)
    : ((a = removeCssClass(b.className, "valid")),
      (a = removeCssClass(a, "invalid")),
      "" !== c && (a += " invalid"),
      (b.className = a),
      this.getOption("extraInputID").length &&
        (A$(this.getOption("extraInputID")).value = ""),
...
AMIB.persianCalendar.prototype.fillDateField = function (b) {
  ...
  a.className = c + " valid";
  this.getOption("extraInputID").length &&
    this.getOption("extraInputFormat").length &&
...
AMIB.persianCalendar.prototype.keyDownHandler = function (b, a) {
  ...
  if (
    ...
    if (38 === c || 40 === c) {
      ...
      !1 !== d &&
        (38 === c
          ? a.fillDateField(jd_to_persian(persian_to_jd(d[0], d[1], d[2]) + 1))
          : 40 === c &&
            a.fillDateField(jd_to_persian(persian_to_jd(d[0], d[1], d[2]) - 1)),
        a.input.select(),
        prvDef(b));
    } else b.ctrlKey || prvDef(b);
};
function isPersianDate(b) {
  ...
  if (0 == b.search(/^\d+\-\d+\-\d+$/)) a = b.split("-", 3);
    ...
    a = [
      b.substr(0, b.length - 4),
      b.substr(b.length - 4, 2),
      b.substr(b.length - 2, 2),
    ];
  else if (
    (a = b.match(/^(\d{2})(\d{2})$/)) ||
    (a = b.match(/^(\d{1,2})[/\-](\d{1,2})$/)) ||
    (a = b.match(/^(\d{1,2})$/))
  )
    (b = new Date()),
      (b = gregorian_to_jd(b.getFullYear(), b.getMonth() + 1, b.getDate())),
      (b = jd_to_persian(b)),
      (a[0] = b[0]),
      "undefined" == typeof a[2] && (a[2] = b[1]),
      12 >= parseInt(a[2], 10) && ((b = a[1]), (a[1] = a[2]), (a[2] = b));
  else return !1;
  for (b = 0; 2 >= b; ++b) a[b] = parseInt(a[b], 10);
  if (12 < a[1] || 0 >= a[1]) return !1;
  a[2] > persianMonthDays(longYear(a[0]), a[1]) &&
    ((b = a[2]), (a[2] = a[0]), (a[0] = b));
...
function persian_to_jd(b, a, c) {
  ...
  return (
    c +
    (7 >= a ? 31 * (a - 1) : 30 * (a - 1) + 6) +
    Math.floor((682 * d - 110) / 2816) +
    365 * (d - 1) +
    1029983 * Math.floor(b / 2820) +
    (PERSIAN_EPOCH - 1)
  );
}
...
function gregorian_to_jd(b, a, c) {
  return (
    ...
    Math.floor((b - 1) / 400) +
    Math.floor(
      (367 * a - 362) / 12 + (2 >= a ? 0 : leap_gregorian(b) ? -1 : -2) + c
    )
  );
}
  ...
  var faDigitsToEn = function (b) {
    for (var a = b.length, c = "", d = 0, d = 0; d < a; ++d)
      c += String.fromCharCode(
        1776 <= b.charCodeAt(d) && 1785 >= b.charCodeAt(d)
          ? b.charCodeAt(d) - 1728
          : b.charCodeAt(d)
      );
    return c;
...
if (!fdef(enDigitsToFa))
  var enDigitsToFa = function (b) {
    ...
    for (var a = b.length, c = "", d = 0, d = 0; d < a; ++d)
      c += String.fromCharCode(
        48 <= b.charCodeAt(d) && 57 >= b.charCodeAt(d)
          ? b.charCodeAt(d) + 1728
          : b.charCodeAt(d)
      );
    return c;
...
"map" in Array.prototype ||
  (Array.prototype.map = function (b, a) {
